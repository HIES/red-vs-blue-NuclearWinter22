...
public class PurpleMap {
    ...
    public class SubRegion {
        ...
        public void setColor() {
            color = new Color((votes[0]) / (votes[0] + votes[1] + votes[2]), (votes[2]) / (votes[0] + votes[1] + votes[2]), (votes[1]) / (votes[0] + votes[1] + votes[2]));
        }
    }

    public static void main(String[] args) throws Exception {
        PurpleMap thisMap = new PurpleMap();
    ...
    public void getVoteData(String year) throws Exception {
        for (String key : subRegions.keySet()) {
            ...
            while (inputObject.hasNextLine()) {
                ...
                float[] votes = {inputObject.nextInt(), inputObject.nextInt(), inputObject.nextInt()};
                inputObject.nextLine();
